...
const projects = [
  {
    name: 'Edupay',
    description: 'A crypto payment solution for educational institutions.',
    link: { href: 'https://edupaydefi.vercel.app', label: 'EdupayDefi' },
    logo: logoPlanetaria,
    preview: '@/images/Projects/Edupay new.svg?height=400&width=600',
  },
  {
    name: 'SurPath Hub',
      ...
      >
        ...
        >
          {projects.map((project) => (
            <Card as="li" key={project.name} className="flex flex-col overflow-hidden">
