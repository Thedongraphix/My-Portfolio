...
I'm Chris Oketch, currently a student at the [Technical University of Kenya](https://www.tuk.ac.ke/) pursuing a Bachelor of Computer Science in Information Technology . I'm passionate about anything to do with Tech but majorly Frontend Development and blockchain development . I created my GitHub account on February 2023, because of the love for open source.

#### Current roles:
- Frontend Developer at [Zenlipa](https://zenlipa.co.ke/)
- I founded [Edupay](https://github.com/Edupay/) & [WebX DAO](https://github.com/WebXDAO) - Open Source Communities & Platform As A Service
